...
1. **Clone Repo**:
   ```bash
   git clone [https://github.com/damar22004-debug/Projek-Uas---Manajemen-Tugas-Kuliah.git](https://github.com/damar22004-debug/Projek-Uas---Manajemen-Tugas-Kuliah.git)
